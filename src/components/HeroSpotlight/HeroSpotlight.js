		...
		() => {
			...
			mm.add(`(min-width: ${DESKTOP_MIN}px)`, () => {
				...
				const handleMouseMove = (e) => {
					if (
						(e.clientX / window.innerWidth - 0.5) * 2 > -0.35 &&
						e.clientX > -100
					) {
				...
				<div className={`container pad ${styles.heroInner}`}>
					<div className={styles.heroTop}>
						<Copy
							...
							delay={isInitialLoad ? 6.4 : 1.125}
						>
							<p>Hi, we are A27 Web Lab.</p>
							<br />
							<p>We know you want more than just a website.</p>
							<p>You want more CLIENTS, SALES, ATTENTION.</p>
							<br />
							<p className="hero-p-accent"> WE MAKE WEBSITES THAT EARN IT.</p>
						</Copy>
					</div>
