...
const SPOTS = [
	{ src: "/images/spotlight/spotlight_img_2.png", alt: "" },
	{ src: "/images/spotlight/spotlight_img_3.png", alt: "" },
	{ src: "/images/spotlight/spotlight_img_4.png", alt: "" },
];
			...
			<div className={`container pad ${styles.inner}`}>
				...
				>
					<h2 className={styles.headline}>
						<span className={styles.line}>We offer</span>
						<span className={styles.line}>
							<span className={styles.word}>Powerful</span>
							<Spot {...SPOTS[0]} />
							<span className={styles.word}>Digital</span>
						</span>
						<span className={styles.line}>Solutions</span>
						<span className={styles.line}>
							<span className={styles.word}>that</span>
							<Spot {...SPOTS[1]} />
							<span className={styles.word}>Convert</span>
						</span>
						<span className={styles.line}>Visitors</span>
						<span className={styles.line}>
							<span className={styles.word}>Into</span>
							<Spot {...SPOTS[2]} />
							<span className={styles.word}>Clients</span>
						</span>
					</h2>
